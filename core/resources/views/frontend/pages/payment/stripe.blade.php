                ...
                <div class="card custom--card h-100">
                    ...
                    <div class="card-body ">
                        ...
                        <form role="form" id="payment-form" method="{{$data->method}}" action="{{$data->url}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="name" class="form--label text-white">@lang('Name on Card')</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control form--control custom-input" name="name" autocomplete="off" autofocus/>
                                        <span class="input-group-text bg--primary">F</span>
                                    </div>

                                </div>
                                <div class="col-md-6">
                                    <label for="cardNumber" class="form--label text-white">@lang('Card Number')</label>
                                    <div class="input-group">
                                        <input type="tel" class="form-control form--control custom-input" name="cardNumber" autocomplete="off" required autofocus/>
                                        <span class="input-group-text bg--primary">N</span>
                                    </div>
                                </div>
                            </div>
