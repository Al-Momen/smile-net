        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-lg-4 row-cols-md-3 g-5 pt-3 px-1">
                @foreach ($popularBooks as $popular_book)
                    @if ($popular_book->book->bookable_type == 'App\Models\User' && $popular_book->book->admin_status == 1)
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('magazine_details', $popular_book->book->id) }}"
                                        class="btn btn-outline-secondary">More
                                        Details</a>
                                </div>
                            </div>
                    ...
                    @endif
                    @if ($popular_book->book->bookable_type == 'App\Models\GeneralUser' &&
                        $popular_book->book->status == 1 &&
                        $popular_book->book->admin_status == 1)
