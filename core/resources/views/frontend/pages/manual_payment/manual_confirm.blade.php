            ...
            <div class="col-md-8">
                <div class="card custom--card h-100">
                    <div class="card-header p-4">
                        <div class="card-title text-white"><h4 class="text-white">Confirm Book</h4></div>
                    </div>
                    <div class="card-body  ">
                        <form class="step__form" action="{{ route('book.buy.manual.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <p class="my-4 text-center text-white" style="color: red">  {!! $bookTransaction->gateway->description !!} </p>
                                    <br>
                                </div>
