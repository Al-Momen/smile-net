        ...
        <div class="container py-5">
            <div class="row shadow-lg p-3">
                ...
                <div class="col-12 col-md-6 col-lg-6 text-white my-auto pt-3 pt-lg-0">
                    ...
                    @if ($book->bookable_type == 'App\Models\User')
                    <div class="d-lg-flex justify-content-between">
                        <a href="" class="book-author text-decoration-none pb-4 d-flex">
                            <div class="pe-3">
                            ...
                            <div>
                                <h4 class="fs-6 text-capitalize">full name<span class="text-primary"
                    ...
                    @else
                        <div class="d-lg-flex justify-content-between">
                            ...
                            <div class="social-menu">
                                <ul>
                                    <li><a href="{{$book->user->facebook}}" target="blank"><i class="fab fa-facebook"></i></a></li>
                                    <li><a href="{{$book->user->instagram}}" target="blank"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="#" target="blank"><i class="fab fa-twitter"></i></a></li>
                                </ul>
                            </div>
                        </div>
