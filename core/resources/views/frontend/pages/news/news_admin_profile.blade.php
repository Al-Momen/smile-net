            ...
            <div class="row g-5 d-flex justify-content-center align-items-center">
                <div class="col-lg-4 col-md-12 col-12">
                    <img class="img-fluid rounded d-block mx-auto"
                        src="{{ asset('core\storage\app\public\admin-profile\\' . $newsprofile->admin->adminUser->profile_pic) }}" alt="Image"
                    ...
                    <div class="row g-4k">
                        <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                            <div class="d-flex justify-content-between mt-4 rounded-2 p-2 user-card">
                                ...
                                <p class="text-white m-0 ">{{ $newsprofile->admin->adminUser->first_name}} {{ $newsprofile->admin->adminUser->last_name}}</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                            <div class="d-flex justify-content-between mt-4 rounded-2 p-2 user-card">
                                ...
                                <p class="text-white m-0 ">{{ $newsprofile->admin->email}} </p>
                            </div>
                        </div>  
                        <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                            <div class="d-flex justify-content-between mt-4 rounded-2 p-2 user-card">
                                <p class="text-white m-0 fw-bold">Country:</p>
                                <p class="text-white m-0 ">{{ $newsprofile->admin->adminUser->country ?? 'N/A' }}</p>
                            </div>
                        </div>
                        <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                            <div class="d-flex justify-content-between mt-4 rounded-2 p-2 user-card">
                                <p class="text-white m-0 fw-bold">Facebook:</p>
                                <p class="text-white m-0 ">{{ $newsprofile->admin->facebook ?? 'N/A' }}</p>
                            </div>
                        </div>
                        <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                            <div class="d-flex justify-content-between mt-4 rounded-2 p-2 user-card">
                                <p class="text-white m-0 fw-bold">Instagram:</p>
                                <p class="text-white m-0 ">{{ $newsprofile->admin->instagram ?? 'N/A' }}</p>
                            </div>
                        </div>
                        <div class="mb-4 col-lg-6 col-md-6 col-12 pe-4">
                            <div class="d-flex justify-content-between mt-4 rounded-2 p-2 user-card">
                                <p class="text-white m-0 fw-bold">Twitter:</p>
                                <p class="text-white m-0 ">{{ $newsprofile->admin->twitter ?? 'N/A' }}</p>
                            </div>
                        </div>
