                ...
                <div>
                    ...
                    <div class="text-white">
                        ...
                        <div class="d-flex pt-3">
                            ...
                            <p id="price" class="ms-auto">{{ $plan->price }} </p> <span class="px-1"
                                style="margin-top: 2px;">{{ $plan->event->priceCurrency->symbol }}</span>
                        </div>
                        <div class="d-flex">
                            <span class="fw-light">Discount</span>
                            <p id="discountPara" class="ms-auto">{{ $couponCheck->discount_price ?? '0' }}</p><span
                                class="px-1" style="margin-top: 2px;">{{ $plan->event->priceCurrency->symbol }}</span>
                        </div>
                        <hr class="text-danger  rounded w-100">
                        <div class="d-flex py-3">
                            <span class="fw-bold">Amount to be paid</span>
                            <p id="amountPaidPara" class="ms-auto">{{ $plan->price }}</p><span class="px-1"
                                style="margin-top: 2px;">{{ $plan->event->priceCurrency->symbol }}</span>
                        </div>
                        ...
                        <form class="pb-4" id="paymentsgateway" action="" method="post">
                            ...
                            <div class="d-flex justify-content-center pb-3">
                                ...
                                <div class="radio-item d-flex justify-content-center px-3">
                                    <input type="text" name="plan_id" class="radio-item-two d-none"
                                        value="{{ $plan->id }}">
                                </div>
                                <div class="radio-item d-flex justify-content-center px-3">
