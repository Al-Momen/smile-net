            ...
            <div class="row pt-3">
                <div class="col-lg-4 col-md-12 mb-4 text-white">
                    <div class="card card2 h-100">
                        <div class="card-body">
                            <h5 class="card-title text-capitalize">{{$plan->ticketType->name}}</h5>

                            <span class="h2 pt-4">{{$plan->event->priceCurrency->symbol}}{{$plan->price}}</span>
                            <ul>
                                <li>Event Attendance</li>
                                <li>Tea And Coffee</li>
                                <li>3 Lottery Ticket</li>
                            </ul>
                            <a href="{{route('plan.pricing.place.order',$plan->id)}}" class="text-decoration-none w-100">
