        ...
        <div class="shadow-lg p-4 card-1 my-3">
            <div class="row g-5 d-flex justify-content-center">
                <div class="col-lg-4 col-md-12 col-12">
                    <img class="img-fluid rounded d-block mx-auto" {{-- src="{{storage_path().'/app/public/profile/'.$profile->photo}}" alt="" height="200" width="200"> --}}
                        src="{{ asset('core\storage\app\public\profile\\' . $profile->photo) }}" alt="Image" height="200"
                        width="200">
                    <div>
