...
@section('content')
    <div class="table-content mt-5" style="display:flex; ">
        <div class="row">
            <div class="card adcardmodal" style="width: 30rem;background: transparent">
                ...
                <div class="card-body ">
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-center align-items-center text-center">
                        ...
                        <span class="text-center"><img
                                src="{{ getImage(imagePath()['profile']['user']['path'].'/'. $event_request_view->user->photo) }}"
                    ...
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        ...
                        <span><strong class="text-white">{{ $event_request_view->transaction_id }}</strong></span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Name:</strong></span>
                        <span class="text-white">{{ $event_request_view->user->full_name }}</span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Email:</strong></span>
                        <span class="text-white">{{ $event_request_view->user->email }}</span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Phone:</strong></span>
                        <span class="text-white">{{ $event_request_view->user->phone }}</span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Country:</strong></span>
                        <span class="text-white">{{ $event_request_view->user->country }}</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="row ms-5">
            <div class="card adcardmodal" style="width: 30rem;">
                ...
                <div class="card-body" style="flex: initial">
                    @php
                        $manual_getway_fields = json_decode($event_request_view->gateway_parameters);
                    @endphp
                    ...
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        ...
                        <span><strong class="text-white">{{ $event_request_view->payment_getway }}</strong></span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Event Price:</strong></span>
                        <span><strong class="text-white">{{ $event_request_view->paid_price }}
                                {{ $priceCurrency->symbol }}</strong></span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Discount:</strong></span>
                        <span><strong class="text-white">{{ $event_request_view->discount }} {{ $priceCurrency->symbol }}</strong></span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Charge:</strong></span>
                        <span><strong class="text-white">{{ $event_request_view->charge }} {{ $priceCurrency->symbol }}</strong></span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Rate:</strong></span>
                        <span><strong class="text-white">{{ $event_request_view->rate }} {{ $priceCurrency->symbol }}</strong></span>
                    </div>
                    <hr>
                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Total Amount:</strong></span>
                        <span><strong class="text-white">{{ $event_request_view->final_amo }} {{ $priceCurrency->symbol }}</strong></span>
                    </div>
                    <hr>

                    <div class="block d-md-flex mb-sm-2 mb-md-0 justify-content-between align-items-center">
                        <span><strong class="text-white">Status:</strong></span>
                        @if($event_request_view->status == 1)
                            <span class="badge bg-success"> Approved </span>
                        @elseif ($event_request_view->status == 2)
                    ...
                    @if ($event_request_view->reject)
                        ...
                        <div class="block d-md-flex mt-2 mb-sm-2 mb-md-0 justify-content-between align-items-center">
                            <span class="text-danger"><strong>{{ $event_request_view->reject ?? null }}</strong></span>
