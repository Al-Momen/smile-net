    ...
    <div class="table-content">
        <div class="row">
            ...
            <div class="row">
                ...
                @foreach ($ticketTypePlans as $ticketTypePlan)
                    <div class="col-12">
                        <div class="card mb-3">
                            <div class="card-text mt-2">
                                <div class="d-flex justify-content-between rec-box-text">
                                    <div class="d-flex">
                                        ...
                                        <div class="">
                                            <h4 class="text-capitalize"> Ticket Plan</h4>
                                            <span class="text-capitalize">{{ $ticketTypePlan->ticket_type->name }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <h3>{{ $ticketTypePlan->paid_price }}{{ $priceCurrency->symbol }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
