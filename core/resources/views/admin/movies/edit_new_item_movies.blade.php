...
@section('content')
    ...
    <form action="{{ route('admin.update.newItemSeason',$newItemMovies->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
            <div class="modal-content">
                <div class="modal-header bg--primary">
                    <h5 class="modal-title text-white">@lang('Edit New Item Movies')</h5>
                </div>
                <div class="modal-body">
