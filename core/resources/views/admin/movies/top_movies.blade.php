                ...
                <tbody class="text-center" style="color:#7b8191">
                    ...
                    @foreach ($topMovies as $topMovie)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.top.movies.status.edit', $topMovie->id) }}" method="POST">
                                    @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header ">
                    <h5 class="modal-title text--base">@lang('Top Movies')</h5>
                    ...
                    <div class="modal-body">
                            <div class="row g-4k" style="padding: 0px 20px;">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 form-group">
                                    ...
                                    <input type="file" src="" class="form--control img-height" name="image"
                                        accept="image/*" id="image">
                                </div>
                                <div class="col-lg-12 col-md-12 col-12 form-group">
                                    <label for="">@lang('Movies/Music Video') </label>
                                    <input type="file" src="" class="form--control img-height" name="mp4"
                                        accept="video/*,.mkv" id="mp4">
                                </div>
                                <div class="col-lg-12 col-md-12 col-12 form-group w-100">
