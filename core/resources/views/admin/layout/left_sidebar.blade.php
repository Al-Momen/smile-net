            ...
            @else
                ...
                <li class="sidebar-menu-item">
                    ...
                    <a href="{{ route('admin.users.active') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/active') ? 'text-white' : '' }}">Active
                            Users</span>
                    ...
                    <a href="{{ route('admin.users.banned') }}"
                        ...
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/banned') ? 'text-white' : '' }}">Banned
                            Users</span>
                        <div class="sidebar-item-badge style">
                    ...
                    <a href="{{ route('admin.users.email.verified') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/email-verified') ? 'text-white' : '' }}">Email
                            Verified </span>
                        <div class="sidebar-item-badge style">
                    ...
                    <a href="{{ route('admin.users.email.unverified') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/email-unverified') ? 'text-white' : '' }}">Email
                            Unverified</span>
                        <div class="sidebar-item-badge style">
                    ...
                    <a href="{{ route('admin.users.sms.verified') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/sms-verified') ? 'text-white' : '' }}">SMS
                            Verified</span>
                        <div class="sidebar-item-badge style">
                    ...
                    <a href="{{ route('admin.users.sms.unverified') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/sms-unverified') ? 'text-white' : '' }}">SMS
                            Unverified</span>
                        <div class="sidebar-item-badge style">
                    ...
                    <a href="{{ route('admin.users.kyc.verified') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/kyc-verified') ? 'text-white' : '' }}">KYC
                            Verified</span>
                        <div class="sidebar-item-badge style">
                    ...
                    <a href="{{ route('admin.users.kyc.unverified') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/kyc-unverified') ? 'text-white' : '' }}">KYC
                            Unverified</span>
                        <div class="sidebar-item-badge style">
                    ...
                    <a href="{{ route('admin.users.email.all') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('users/send-email') ? 'text-white' : '' }}">Email To
                            Users</span>
                    </a>
            ...
            <ul class="sidebar-submenu" @if (Request::is('email-template*')) style="display:block" @endif>
                ...
                <li class="sidebar-menu-item">
                    <a href="{{ route('admin.email.template.global') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('email-template/global') ? 'text-white' : '' }}">Global
                            Template</span>
                    </a>
                    <a href="{{ route('admin.email.template.index') }}" class="nav-link active">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('email-template/index') ? 'text-white' : '' }}">Default
                            Template</span>
                    </a>
                    <a href="{{ route('admin.email.template.setting') }}" class="nav-link ">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('email-template/setting') ? 'text-white' : '' }}">Email
                            Configuration</span>
                    </a>
                </li>
            </ul>
            ...
            <ul class="sidebar-submenu {{ Request::is('setting*') ? 'd-block' : ' ' }}">
                <li class="sidebar-menu-item">
                    <a href="{{ route('admin.setting.index') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('setting/index') ? 'text-white' : ' ' }}">Site
                            Settings</span>
                    </a>
                    <a href="{{ route('admin.setting.logo.icon') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span class="menu-title {{ Request::is('setting/logo-icon') ? 'text-white' : ' ' }}">Logo &
                            favicon</span>
                    </a>
            ...
            <ul class="sidebar-submenu {{ Request::is('payment/gateway*') ? 'd-block' : ' ' }}">
                <li class="sidebar-menu-item">
                    <a href="{{ route('admin.gateway.automatic.index') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span
                            class="menu-title {{ Request::is('payment/gateway/automatic/index') ? 'text-white' : ' ' }}">Automatic</span>
                    </a>
                    <a href="{{ route('admin.gateway.manual.index') }}" class="nav-link">
                        <i class="menu-icon las la-dot-circle"></i>
                        <span
                            class="menu-title {{ Request::is('payment/gateway/manual/index') ? 'text-white' : ' ' }}">Manual</span>
                    </a>
                </li>
            </ul>
