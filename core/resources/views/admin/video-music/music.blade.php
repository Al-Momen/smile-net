...
@section('content')
    ...
    <!-- Modal music video -->
    <div class="modal fade" id="exampleMusicVideo" tabindex="-1" aria-labelledby="exampleMusicVideoLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row g-4k" style="padding: 20px;">
                                    ...
                                    <div class="mb-3 mt-4 col-lg-6 col-md-6 col-12 pe-4">
                                        <label for="audio" class="form-label">@lang('Music Video')</label>
                                        <input type="file" src="" class="form-control px-3 pt-2"
                                        name="mp4" accept="video/*,.mkv" id="mp4" required>
                                    </div>
                                </div>
                            </div>
                        </div>
