...
@section('content')
    <div class="dashboard-title-part">
        ...
        <div class="view-prodact">
            <a href="{{route('admin.buy.manual.paymentgetway.addpayment')}}">
                            ...
                            @foreach ($manualPayment as $item)
                                <tr>
                                    ...
                                    <td><img class="table-user-img img-fluid d-block me-auto"
                                            ...
                                            alt="Image"></td>
                                    <td>
                                        <form action="{{ route('admin.buy.manual.getway.status.edit', $item->id) }}" method="POST">
                                            @csrf
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('admin.buy.manual.paymentgetway.destroy', $item->id) }}"class="btn btn-danger rounded"><i
