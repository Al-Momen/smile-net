...
function imagePath()
{
    ...
    $data['image'] = [
        ...
        'user-default' => 'assets/admin/images/default/default.svg',
    ];
    $data['withdraw'] = [
        'method' => [
    ...
    $data['kyc'] = [
        'agent'=> [
            'path'=>'assets/images/kyc/agent',
        ],
        'user'=> [
            'path'=>'assets/images/kyc/user',
        ],
        'merchant'=>[
            'path'=>'assets/images/kyc/merchant',
        ]
    ];
    return $data;
}
...
{
    $config = null;
    $check = ['currency_model', 'currency_symbol_position', 'system_default_currency'];
...
// If User Image Is Null it show default Image
if(!function_exists('userImage')) {
    function userImage($image) {
        if($image != null) return $image;
        return imagePath()['image']['user-default'];
    }
}


// If Route Is not Available in system return javascript:void(0)
